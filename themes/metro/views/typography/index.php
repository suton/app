...
<?php $cs->registerCssFile($baseUrl.'/assets/css/prettify.css');?>		
...
<?php Yii::app()->clientScript->registerScriptFile($baseUrl.'/assets/js/prettify.js', CClientScript::POS_END);?>
...
EOD;
Yii::app()->clientScript->registerScript('typography', $script,  CClientScript::POS_END);
?>