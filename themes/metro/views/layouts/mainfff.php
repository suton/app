...
<html lang="en">
	<head>
		...
		<link rel="<?php echo $baseUrl ?>/stylesheet" href="assets/css/font-awesome.min.css" />
		...
		<link rel="stylesheet" href="<?php echo $baseUrl ?>/assets/css/jquery-ui-1.10.3.custom.min.css" />
		...
		<link rel="stylesheet" href="<?php echo $baseUrl ?>/assets/css/bootstrap-timepicker.css" />
		<link rel="stylesheet" href="<?php echo $baseUrl ?>/assets/css/daterangepicker.css" />
		<link rel="stylesheet" href="<?php echo $baseUrl ?>/assets/css/colorpicker.css" />
...
<![endif]-->
		...
		<script src="<?php echo $baseUrl ?>/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		...
		<script src="<?php echo $baseUrl ?>/assets/js/fuelux/fuelux.spinner.min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/date-time/bootstrap-datepicker.min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/date-time/bootstrap-timepicker.min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/date-time/moment.min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/date-time/daterangepicker.min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/bootstrap-colorpicker.min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/jquery.knob.min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/jquery.autosize-min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/jquery.inputlimiter.1.3.1.min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/jquery.maskedinput.min.js"></script>
		<script src="<?php echo $baseUrl ?>/assets/js/bootstrap-tag.min.js"></script>
