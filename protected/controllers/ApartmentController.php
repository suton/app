...
class ApartmentController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','UpdateAmphur'),
				'users'=>array('*'),
			),
	...
	{
		$dataProvider=new CActiveDataProvider('Apartment');
	 ...
	 * @param Apartment $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
        ...
        public function actionUpdateAmphur(){
            ...
            $amphur=  Amphur::model()->findAll('PROVINCE_ID=:PROVINCE_ID',array(':PROVINCE_ID'=>(int)$_POST['Apartment']['province_id']));
