...
class Room extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('room_code,fee_group_id', 'required'),
			array('floor_id, building_id, fee_group_id', 'numerical', 'integerOnly'=>true),
			array('room_code', 'length', 'max'=>15),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, room_code, floor_id, building_id, fee_group_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'rentRooms' => array(self::HAS_MANY, 'RentRoom', 'room_id'),
		);
	}
