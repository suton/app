...
class Rating extends CActiveRecord
{
        ...
        public static function avgRating($building_id){
            $criteria=new CDbCriteria();
            $criteria->select=array('AVG(rating) as avg');
            $criteria->condition='building_id='.$building_id;
            
            $model=  Rating::model()->find($criteria);
            return round($model->avg);
	...
	public function rules()
	{
		...
		return array(
			array('building_id, rating', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, building_id, rating', 'safe', 'on'=>'search'),
		);
	}
